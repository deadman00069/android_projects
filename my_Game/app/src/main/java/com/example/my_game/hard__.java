...
public class hard__ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard__);
        ...
        ct=new CountDownTimer(10000,1000) {
            ...
            {
                mp.start();
                Intent intent = new Intent(hard__.this,score.class);
