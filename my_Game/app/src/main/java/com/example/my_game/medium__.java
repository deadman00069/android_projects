...
public class medium__ extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medium__);
        ...
        ct=new CountDownTimer(10000,1000) {
            ...
            {
                mp.start();
                Intent intent = new Intent(medium__.this,score.class);
